  ...
  let s:guishade0 = "#282a36"
  let s:guishade1 = "#464751"
  let s:guishade2 = "#63656c"
  let s:guishade3 = "#818287"
  let s:guishade4 = "#9fa0a1"
  let s:guishade5 = "#bdbdbc"
  let s:guishade6 = "#dadbd7"
  let s:guishade7 = "#f8f8f2"
  let s:guiaccent0 = "#ff5555"
  let s:guiaccent1 = "#ffb86c"
  let s:guiaccent2 = "#f1fa8c"
  let s:guiaccent3 = "#50fa7b"
  let s:guiaccent4 = "#8be9fd"
  let s:guiaccent5 = "#6272a4"
  let s:guiaccent6 = "#bd93f9"
  let s:guiaccent7 = "#ff79c6"
  ...
  let s:ctermaccent4 = 159
  let s:ctermaccent5 = 103
